...
export default function HandRaisePanel({ roomId, userId, userName, isHost, socket }) {
        ...
        {queue.length === 0 ? (
          ...
          <div className="space-y-2">
            {queue.map((item, index) => (
              <div key={item.userId} className="flex items-center justify-between p-3 rounded-xl glass-light animate-slide-up">
