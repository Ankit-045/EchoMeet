              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-dark-500">
                    ...
                    {a.leaveTime &&
                      ` — Left ${new Date(a.leaveTime).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}`}
                  </p>
                </div>
              </div>
              <div className="text-right">
                <span
                  className={`inline-block px-2 py-0.5 rounded-full text-[10px] font-medium capitalize ${statusColor(a.status)}`}
                >
                  {a.status}
                </span>
